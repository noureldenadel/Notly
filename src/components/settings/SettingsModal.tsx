...
const cardColorOptions = [
    { value: 'highlight-blue', label: 'Blue', color: 'hsl(210 90% 65%)' },
    { value: 'highlight-purple', label: 'Purple', color: 'hsl(270 70% 65%)' },
    { value: 'highlight-green', label: 'Green', color: 'hsl(150 70% 50%)' },
    { value: 'highlight-yellow', label: 'Yellow', color: 'hsl(45 93% 65%)' },
    { value: 'highlight-pink', label: 'Pink', color: 'hsl(330 80% 65%)' },
];
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Color for new cards</p>
                                </div>
                                <Select
                                    value={appearance.defaultCardColor}
                                    onValueChange={(value) => updateAppearance({ defaultCardColor: value })}
                                >
                                    <SelectTrigger className="w-[140px]">
                                        <SelectValue />
                                    </SelectTrigger>
